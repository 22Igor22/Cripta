...
namespace Lab10ElGam
{
    internal class ElGamal
    {
        private static void Main()
        {
            ...
            Console.WriteLine($"encrypt: {cryptedText} lead time {(float)time.ElapsedMilliseconds / 1000} sec");
            ...
            time.Stop();
            Console.WriteLine($"decrypt: {decryptedText} lead time {(float)time.ElapsedMilliseconds / 1000} sec");
    ...
    public class ElGam
    {
        ...
        private static string Crypt(int p, int g, int x, string inString)
        {
            ...
            Console.WriteLine($"close key (p,g,x)=({p},{g},{x})");
