...
namespace Lab8
{
    internal class RSA
    {
        private static void Main()
        {
            ...
            string text = "BayIgor";
            Console.WriteLine($"Messgae: {text}\n");
            ...
            Console.WriteLine($"Encrypt:\n{cryptedText} lead time {(float)time.ElapsedMilliseconds / 1000} c");
            ...
            time.Stop();
            Console.WriteLine($"Decrypt:\n{decryptedText} lead time {(float)time.ElapsedMilliseconds / 1000} c");
